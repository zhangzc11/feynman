...
\begin{fmffile}{FeynmanQQtoVHtoVV}
\parbox{300mm}{
...
\begin{fmfgraph*}(180,90) %\fmfpen{thick}
  ...
  \fmf{dashes, label=\PH, label.side=right, label.dist=5.}{v2,v3}
  ...
  \fmfv{decor.shape=square,decor.filled=100, decor.size=.08w, foreground=red}{v3}
